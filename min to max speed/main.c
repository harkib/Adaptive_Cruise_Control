...
volatile signed long ComparatorValue = 5000;

volatile int test_index;
...
int main(void){
    ...
    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOE); //MM added for stop test
...
//                GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_2, 0xFF);
                SysTick_Wait10ms(1000*1.5); // delay for 3 seconds (1000 --> 2 sec)
//                GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_2, 0x00);
                ...
                SysTick_Wait10ms(1000*1.5); // delay for 2 seconds
