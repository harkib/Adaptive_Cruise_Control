...
// global variables v2
volatile uint32_t ObstacleDist_1 = 0;     // Variable to store distance 1 of the Obstacle
volatile uint32_t ObstacleDist_2 = 0;     // Variable to store distance 2 of the Obstacle
volatile uint32_t Rel_Speed = 0;     //
volatile uint32_t Host_Speed = 0;     //
volatile uint32_t Lead_Speed = 0;     //
volatile uint32_t Desired_Dis = 0;     //
volatile bool dis1_filled = 0;
volatile bool dis2_filled = 0;
volatile uint32_t RelSpeed = 0;
int deltaT = 0; // interrupt period --- set bellow in code!!!
...
void SetRelDis(){
    ...
    if (!dis1_filled){
        ObstacleDist_1 = ui32ObstacleDist;
        dis1_filled = 1;
    }else{
        ObstacleDist_2 = ui32ObstacleDist;
        dis2_filled = 1;
    }
}

void SetRelSpeed(){
    RelSpeed = (ObstacleDist_2 - ObstacleDist_1) / deltaT;
}
